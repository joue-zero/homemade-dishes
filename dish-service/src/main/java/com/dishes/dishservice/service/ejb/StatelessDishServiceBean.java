...
/**
 * Stateless Session Bean implementation of the DishService
 */
@Stateless
public class StatelessDishServiceBean implements DishServiceLocal {
    private static final Logger logger = LoggerFactory.getLogger(StatelessDishServiceBean.class);
